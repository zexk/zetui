...
pub const Context = struct {
    ...
    pub fn width(self: *const Context) i32  { return c.zetui_width(self.raw); }
    pub fn height(self: *const Context) i32 { return c.zetui_height(self.raw); }
    ...
    pub fn cursorHide(self: *Context) void { c.zetui_cursor_hide(self.raw); }
    pub fn cursorShow(self: *Context) void { c.zetui_cursor_show(self.raw); }
